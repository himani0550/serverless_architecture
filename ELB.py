...
def lambda_handler(event, context):
    ...
    elb_name = 'arn:aws:elasticloadbalancing:ap-south-1:295397358094:targetgroup/himani-targetgrp/8c5ffb731df13c62'
    ...
    if unhealthy_instances:
        ...
        sns_topic_arn = 'arn:aws:sns:ap-south-1:295397358094:Himani-topic'
